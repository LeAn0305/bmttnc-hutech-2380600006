...
class MyApp(QMainWindow):
    ...
    def call_api_encrypt(self):
        ...
        # Ràng buộc Playfair: Key chỉ được chứa chữ cái (A-Z, a-z)
        if not key_input.isalpha():
            self.show_message(QMessageBox.Warning, "Ràng buộc sai", "Key của thuật toán Playfair chỉ được chứa các chữ cái (không chứa số, khoảng trắng hay ký tự đặc biệt)!")
            return
        # ==================================================================
    ...
    def call_api_decrypt(self):
        ...
        # Ràng buộc Playfair: Key chỉ được chứa chữ cái
        if not key_input.isalpha():
            self.show_message(QMessageBox.Warning, "Ràng buộc sai", "Key của thuật toán Playfair chỉ được chứa các chữ cái (không chứa số, khoảng trắng hay ký tự đặc biệt)!")
            return
        # ==================================================================
